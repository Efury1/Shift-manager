...
class OrganisationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create organisation" do
    assert_difference('Organisation.count') do
      post organisations_url, params: { organisation: { employee_name: @organisation.employee_name, hourly_rate: @organisation.hourly_rate } }
    end
  ...
  test "should update organisation" do
    patch organisation_url(@organisation), params: { organisation: { employee_name: @organisation.employee_name, hourly_rate: @organisation.hourly_rate } }
